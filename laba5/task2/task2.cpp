...
int main() {
    try {
        std::vector<std::byte> key = encoder::generate_key(16);

        encoder encoder(key);

        std::string input_file = {R"(C:\Users\lasto\CLionProjects\ilya_laba1\laba5\task2\input.txt)"};
        std::string encryption_file = {R"(C:\Users\lasto\CLionProjects\ilya_laba1\laba5\task2\encryption.txt)"};
        std::string decryption_file = {R"(C:\Users\lasto\CLionProjects\ilya_laba1\laba5\task2\decryption.txt)"};
